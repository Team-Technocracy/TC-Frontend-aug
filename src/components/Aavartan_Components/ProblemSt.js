      ...
      <div className={styles.problemstatementcontainer}>
        <div className={styles.problemstatementmiddle}>
          ...
          <div className={styles.psrow}>
            ...
            <div className={styles.pscol}>
              <a href={Biomed} target="_blank" rel="noreferrer">
                <button className={styles.button49}>BIOMED</button>
              </a>
            </div>
            <div className={styles.pscol}>
              <a href={Biotech} target="_blank" rel="noreferrer">
          ...
          <div className={styles.psrow}>
            <div className={styles.pscol}>
              <a href={Civil} target="_blank" rel="noreferrer">
                <button className={styles.button49}>CIVIL</button>
              </a>
            </div>
            <div className={styles.pscol}>
              <a href={CSE} target="_blank" rel="noreferrer">
                <button className={styles.button49}>CSE/ IT/ MCA</button>
              </a>
            </div>
            <div className={styles.pscol}>
              <a href={ECE} target="_blank" rel="noreferrer">
          ...
          <div className={styles.psrow}>
            <div className={styles.pscol}>
              <a href={EE} target="_blank" rel="noreferrer">
            ...
            <div className={styles.pscol}>
              <a href={MECH} target="_blank" rel="noreferrer">
          ...
          <div className={styles.psrow}>
            <div className={styles.pscol}>
              <a href={Mining} target="_blank" rel="noreferrer">
                <button className={styles.button49}>MINING</button>
              </a>
            </div>
            <div className={styles.pscol}>
              <a href={Chemical} target="_blank" rel="noreferrer">
